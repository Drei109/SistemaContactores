	...
	<div class="card">
		<div class="card-body">
			<form class="mb-3" id="formulario" action="#">
				...
				<div class="form-group row">
					<label class="col-form-label col-lg-2 cursor-pointer" for="direccion">Dirección</label>
					<div class="col-lg-10">
						<input type="text" class="form-control" id="txt_direccion" name="direccion" placeholder="Dirección de Sala">
					</div>
                </div>
...
@push('js')
<script src="{{asset('../assets/views/salas/salasEditarView.js')}}"></script>
@endpush