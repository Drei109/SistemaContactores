		...
		<div class="card-body">
			<form class="mb-3" id="formulario_nuevo" action="#">
				...
				<div class="form-group row">
					...
					<div class="col-lg-10">
						<input type="text" class="form-control" id="txt_nombre" name="nombre" required="required" placeholder="Nombre" autocomplete="off">
					</div>
				</div>

				<div class="form-group row">
					<label class="col-form-label col-lg-2 cursor-pointer" for="txt_descripcion">Dirección</label>
					<div class="col-lg-10">
                        <input type="text" class="form-control" id="txt_direccion" name="direccion" required="required" placeholder="Dirección" autocomplete="off">
                    </div>
				</div>
...
@push('js')
<script src="{{asset('../assets/views/salas/salasNuevoView.js')}}"></script>
@endpush