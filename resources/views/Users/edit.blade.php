...
<div class="content">
    <div class="card">
        <div class="card-body">
                {{-- {{ Form::open(array('route' => 'users.update', 'method' => 'PUT', 'class' => 'mb-3', 'id' => 'formulario_nuevo')) }} --}}
                ...
                <div class='form-group row'>
                    ...
                    <div class="col-lg-10 form-group">
                        ...
                        <div class="form-check">
                            {{ Form::checkbox('roles[]',  $role->id, $user->roles, array('class' => 'form-check-input')) }}
                ...
                <div class="form-group row">
                    {{ Form::label('password', 'Confirmar Password', array('class' => 'col-form-label col-lg-2 cursor-pointer')) }}
                    <div class="col-lg-10">
