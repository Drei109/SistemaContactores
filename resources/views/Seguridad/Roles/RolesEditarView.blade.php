		...
		<div class="header-elements d-none">
			<div class="d-flex justify-content-center">
				...
				<a href="#" class="btn btn-link btn-float text-default btn_nuevo">
					<i class="icon-diff-added text-primary"></i> <span>Regresar</span>
				</a>
				<a href="#" class="btn btn-link btn-float text-default">
					<i class="icon-bin text-primary"></i> <span>Limpiar</span>
				</a>
			</div>
		</div>
	</div>
		...
		<div class="card-body">
			<fieldset class="mb-3">
				...
				<div class="form-group row">
					...
					<div class="col-lg-10">
						<input type="text" class="form-control" id="txt_nombre" name="nombre" placeholder="Nombre del Rol" autocomplete="off">
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-lg-10">
						<textarea rows="3" cols="3" class="form-control" id="txt_descripcion" name="descripcin" placeholder="Descripcion del Rol"></textarea>
					</div>
				</div>
			</fieldset>
		</div>
...
@push('js')
<script src="{{asset('../assets/views/roles/rolesEditarView.js')}}"></script>
@endpush